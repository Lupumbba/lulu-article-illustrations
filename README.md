...
![噜噜正文配图示例总览](examples/lulu-gallery-preview.png)

### AI 需求澄清

![AI 需求澄清](examples/01-need-clarification-preview.png)

### AI 价格智能

![AI 价格智能](examples/02-price-intelligence-preview.png)

### AI 线索评分

![AI 线索评分](examples/03-lead-scoring-preview.png)

### AI 运营自动化

![AI 运营自动化](examples/04-operations-engine-preview.png)
...
├── examples/
│   ├── prompts.md
│   ├── lulu-gallery-preview.png
│   ├── 01-need-clarification-preview.png
│   ├── 02-price-intelligence-preview.png
│   ├── 03-lead-scoring-preview.png
│   └── 04-operations-engine-preview.png
├── lulu-article-illustrations/
│   ├── SKILL.md
│   ├── agents/
│   │   └── openai.yaml
