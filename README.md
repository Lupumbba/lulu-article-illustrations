...
![AI 导购入口变化](examples/ai-cartea-ai-illustrations/01-ai-agent-entry-shift.png)

### AI 需求澄清

![AI 需求澄清](examples/ai-cartea-ai-illustrations/02-ai-need-clarification.png)

### AI 价格智能

![AI 价格智能](examples/ai-cartea-ai-illustrations/03-ai-price-intelligence.png)

### AI 线索评分

![AI 线索评分](examples/ai-cartea-ai-illustrations/04-ai-lead-scoring.png)

### AI 运营自动化

![AI 运营自动化](examples/ai-cartea-ai-illustrations/05-ai-operations-engine.png)
...
│       └── qa-checklist.md
└── scripts/
    └── generate_lulu_article_images.py
```
